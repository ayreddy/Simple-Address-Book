...
<!DOCTYPE html>
<html>
<title>Address Book - CatcM</title>
...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
  <h3 class="w3-bar-item w3-border-bottom"><i class="fa fa-home"></i> Catc Multimedia</h3>
...
<div class="w3-container">
  ...
  <p>Fill out the fields below to edit people from the address book:</p>
